...
export default function LeadForm({ form, setForm, onSave, onCancel }: LeadFormProps) {
        ...
        <div className="grid gap-2">
          ...
          <div className="flex gap-2">
            ...
            <select
              ...
              onChange={(e) =>
                setForm({ ...form, phone_label: e.target.value as Lead["phone_label"] })
              }
        ...
        <div className="grid gap-2">
          ...
          <div className="flex gap-2">
            ...
            <select
              ...
              onChange={(e) =>
                setForm({ ...form, secondary_phone_label: e.target.value as Lead["secondary_phone_label"] })
              }
              className="border border-input bg-background text-sm rounded-md px-2 py-1 w-20"
            >
              <option value="mobile">Mobile</option>
